			...
			<div class="<?php echo esc_attr( implode(' ', $classes) ); ?>" <?php echo wp_kses_post( $single_item_attr ); ?>>
				...
				<div class="single-member" itemscope itemtype="http://schema.org/Person">
					...
					<div class="gs_team_image__wrapper">
						...
						<!-- Image -->
						<?php 
							$image_html = member_thumbnail($gs_member_thumbnail_sizes, false);
							$image_sec_html = member_secondary_thumbnail($gs_member_thumbnail_sizes, false);
							// echo member_thumbnail_with_link( $id, $gs_member_thumbnail_sizes, $gs_member_name_is_linked == 'on', $gs_member_link_type, $link_preview_image == 'on' ); 
							echo $image_html;
							echo $image_sec_html;
						?>
						</div>
					...
					<div class="gs_member_info">
						<div class="title-desig-wrap">
						<!-- Member Name -->
						<?php member_name( $id, true, $gs_member_name_is_linked == 'off', $gs_member_link_type ); ?>
						<?php do_action( 'gs_team_after_member_name' ); ?>

						<!-- Member Designation -->
						<div class="gs-member-desig" itemprop="jobTitle">
							<?php echo wp_kses_post($designation); ?></div>

						<?php do_action( 'gs_team_after_member_designation' ); ?>
						</div><!-- title-desig-wrap -->
