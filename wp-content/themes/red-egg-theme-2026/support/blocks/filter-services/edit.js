...
const apiUrl = '/wp-json/red-egg/v2/cpt-services';
...
const EditFilterServices = ( { attributes, setAttributes, clientId } ) => {
        ...
        <Fragment>
            ...
            <section { ...blockProps }>
                ...
                <div className="block-wrapper">
                    ...
                    <div className="filter-services__grid">
                        ...
                        { resources && resources.length === 0 && (
                            <div className="filter-services__empty">
                                <h3>{ __( 'No services found.', 'red-egg' ) }</h3>
                            </div>
                        ) }
                        { resources === false && (
                            <div className="filter-services__loading">
                                <p>{ __( 'Loading services…', 'red-egg' ) }</p>
                            </div>
                        ) }
                        { resources && resources.length > initialCount && (
                            <p className="filter-services__more-note">
...
export default EditFilterServices;
