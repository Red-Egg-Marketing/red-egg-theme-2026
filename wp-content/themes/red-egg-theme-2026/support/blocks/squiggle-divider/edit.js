/**
 * Squiggle Divider Block – Edit Component
 *
 * Just the squiggle, centered, with padding/margin — like an <hr>.
 */
...
const EditSquiggleDivider = ( { attributes, setAttributes, clientId } ) => {
...
export default EditSquiggleDivider;
